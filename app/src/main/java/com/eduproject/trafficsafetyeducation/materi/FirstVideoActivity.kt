...
class FirstVideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFirstVideoBinding.inflate(layoutInflater)
        ...
        val color = ContextCompat.getColor(this@FirstVideoActivity, R.color.main_blue)
        btnToSecond.backgroundTintList = ColorStateList.valueOf(color)
        val textColor = ContextCompat.getColor(this@FirstVideoActivity, R.color.white)
        ...
        btnToSecond.setOnClickListener {
            if (isVideoFinished) {
                ...
                Handler().postDelayed({
                    val intent = Intent(this@FirstVideoActivity, SecondVideoActivity::class.java)
    ...
    private fun populateContainerMateri(containerMateri: LinearLayout) {
        val images = resources.obtainTypedArray(R.array.images_st)
        val subtitles = resources.getStringArray(R.array.sub_titles_st)
        val descriptions = resources.getStringArray(R.array.descriptions_st)
